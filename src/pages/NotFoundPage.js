    ...
    return (
        <main className={styles['container']} style={{ minHeight: '60vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            <Link to={'/'} className={styles._headding} style={{ textDecoration: 'none' }}>
                <RiRobot2Line className={styles.iconImg} style={{ fontSize: '4rem', marginBottom: '1rem', color: 'var(--main-blue)' }} />
                <br/>
            ...
            <Link to={'/'} style={{ marginTop: '20px', padding: '10px 20px', backgroundColor: 'var(--main-blue)', color: 'white', borderRadius: '8px', textDecoration: 'none' }}>
                Go Back Home
            </Link>
        </main>
    );
