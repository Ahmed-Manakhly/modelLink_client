import Medical_Imaging from './assets/Medical_Imaging.png'
import Clinical_Decision_Support from './assets/Clinical_Decision_Support.png'
...
export const vals = [
  ...
  },
  {
      ...
      img : Efficiency_3,
      description :
      `AI simplifies tasks. Your users—whether developers or medical professionals—can focus on critical work while basic functions are seamlessly handled by AI. Efficiency gains lead to better outcomes and more time for impactful work`,
  },
  {
      title : 'Cost Savings',
      img : payment_2,
  ...
  },
  {
      ...
      img : Data_mining_4,
      description :
      `By democratizing access to diverse datasets and AI models, these platforms fuel innovation across industries. Think of it as a melting pot where ideas collide, leading to breakthroughs and novel applications. Your platform can be a catalyst for AI-driven advancements in healthcare and beyond.`,
  },
  {
  ...
  },
  {
      ...
      img : ico_doctor,
      description :
      `These platforms foster a collaborative environment. Developers, companies, and medical experts share insights, code, and best practices. Collective learning accelerates progress.`,
  },
]
export const popularCards = [
  {
    ...
    img2:"/img/catimages/logodesign.webp",
  },
    {
      card_id: 2,
      title: "ai",
    ...
    },
    {
      ...
      img2: "/img/catimages/animation.jpeg",
    },
    {
      card_id: 4,
      title: "video animation",
      description: "Share your message",
      img: "/img/catimages/wordpress.webp",
      img2: "/img/catimages/wordpress.webp",
    },
    {
      card_id: 5,
      title: "video animation",
      description: "Share your message",
      img: "/img/catimages/translation.webp",
      img2: "/img/catimages/translation.webp",
    },
    {
      card_id: 6,
      title: "video animation",
      ...
      img2: "/img/catimages/social.webp",
    },
    {
      card_id: 7,
      title: "social media",
      description: "Reach more customers",
      img: "/img/catimages/dataentry.webp",
      img2: "/img/catimages/dataentry.webp",
    },
    {
      card_id: 8,
      title: "seo",
...
export const footerCategoriesData = [
  {title:'title-1', links : [
    {title:'title-1',to:'/'},
    {title:'title-2',to:'/'},
    {title:'title-3',to:'/'},
...
export const mobNavData = [
  ...
  },
  {
    ...
    to:'/',
    links :[
      {title:'X-ray Analysis', to:'/models'},
      {title:'MRI Interpretation', to:'/models'},
      {title:'Ultrasound Diagnostics', to:'/models'},
    ]
  },
  {
    title:'Clinical Decision Support',
    img:Clinical_Decision_Support,
    to:'/',
    links:[
      {title : 'Disease Prediction', to:'/models'},
      {title : 'Treatment Recommendations', to:'/models'},
      {title : 'Drug Interaction Alerts', to:'/models'},
    ]
  },
  {
    ...
    to:'/',
    links:[
      {title : 'Teleconsultation', to:'/models'}, 
      {title : 'Remote Vital Signs Monitoring', to:'/models'}, 
      {title : 'Wearable Device Integration', to:'/models'}, 
    ]   
  },
  {
    title:'Pathology and Histopathology',
    img:Pathology_and_Histopathology ,
    to:'/',
    links:[
      {title : 'Cancer Detection', to:'/models'},
      {title : 'Tissue Classification', to:'/models'},
      {title : 'Digital Pathology', to:'/models'},
    ]
  },
  {
    title:'Genomics and Personalized Medicine',
    img:Genomics_and_Personalized_Medicine ,
    to:'/',
    links:[
      {title : 'Genetic Risk Assessment', to:'/models'},
      {title : 'Pharmacogenomics', to:'/models'},
      {title : 'Precision Medicine', to:'/models'},
    ]
  },
]
export const mobNavData_2 = [
  {
    title:'AI Models',
    img:chat_bot ,
    to:'/',
...
export const categoriesList = [
  ...
  //   img:Healthcare_Operations_Optimization ,
  //   to:'/',
  //   items:[
  //     {title : 'Patient Flow Management', to:'/models?category=Patient Flow Management'},
  //     {title : 'Staff Scheduling', to:'/models?category=Staff Scheduling'},
  //     {title : 'Supply Chain Optimization', to:'/models?category=Supply Chain Optimization'},
  //   ]
  // },
]
export const categoriesList_2 = [
  {
    title:'Medical Imaging',
    img:Medical_Imaging ,
    to:'/',
...
export const options = [
  {title : 'Plans', img:pay_Per_Click ,items :[
    {title : 'Pay Per Click'},
    {title : 'Subscription'},
  ]},
  {title : 'Price' ,img:price,items :[
    {title : 'Less Than Or Equal To $300'},
    {title : 'Greater Than Or Equal To $300'},
  ]},
  {title : 'Delivery Time',img:delivery_truck, items :[
    {title : 'Less Than Or Equal To 5 Days'},
    {title : 'Greater Than Or Equal To 5 Days'},
  ]},
]
